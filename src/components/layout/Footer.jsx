    ...
    return(
      ...
      >
        ...
        <div className="flex justify-center mt-8 space-x-6">
            <a href="#" className="text-amber-100 hover:text-blue-700 cursor:pointer">
